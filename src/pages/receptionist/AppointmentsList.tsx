import { Box, Flex, VStack, HStack, Text, Image, Badge, Input, Button } from '@chakra-ui/react'
...
export default function AppointmentsList() {
  ...
  const appointments: Appointment[] = [
    { name: 'Esthera Jackson', email: 'esthera@simmmpple.com', service: 'Extraction', time: '14/06/21', doctor: 'Dr. Juan Dela Cruz', specialty: 'Dentist', avatar: '/sample.png', status: 'Pending' },
    { name: 'John Doe', email: 'john@example.com', service: 'Tooth Filling', time: '15/06/21', doctor: 'Dr. Maria Santos', specialty: 'Dentist', avatar: '/sample.png', status: 'Completed' },
  ]
          ...
          <Box bg="bg.panel" p={6} borderRadius="15px" minH="600px">
            ...
            <Box position="sticky" top={0} zIndex={20} bg="bg.panel" mb={4} p={4} borderRadius="md">
              <Flex align="center" justify="space-between">
                <Text fontSize="2xl" fontWeight="bold">All Appointments</Text>
