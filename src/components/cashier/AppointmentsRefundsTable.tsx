...
export default function AppointmentrRefundsTable() {
  ...
  const handleViewRefund = (refundId: number) => {
    // Navigate to refund detail page with the appointment ID
    navigate(`/appointment-refunds/${refundId}`)
  }
